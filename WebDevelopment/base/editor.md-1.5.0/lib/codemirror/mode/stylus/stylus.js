...
(function(mod) {
  ...
  var wordOperators = ["in", "and", "or", "not", "is a", "is", "isnt", "defined", "if unless"],
      ...
      commonDef = ["@font-face", "@keyframes", "@assets", "@viewport", "@page", "@host", "@supports", "@block", "@css"],
